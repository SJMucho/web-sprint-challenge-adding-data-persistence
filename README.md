...
- Relational Databases are a management system. SQL is the language used to manage that system.

2. Why do tables need a Primary Key?

   -They need a unique number so that you can specify the tables in your queries.
...
4. What do we need in order to have a _many to many_ relationship between two tables?
   ...
   -A seperate table that includes the primary keys of the other two existing tables.
